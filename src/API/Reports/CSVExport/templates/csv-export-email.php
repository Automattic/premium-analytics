 ...
 *
 * @package Automattic\WooCommerce\Analytics\API\Reports\CSVExport
 *
...
<p><?php esc_html_e( 'Your CSV export is ready for download!', 'woocommerce-analytics' ); ?></p>

<h2><?php echo esc_html( $report_label ); ?></h2>

<p>
	<strong><?php esc_html_e( 'Date Range:', 'woocommerce-analytics' ); ?></strong>
	<?php
...
<?php if ( $is_comparison ) : ?>
	<p>
		<strong><?php esc_html_e( 'Comparison Period:', 'woocommerce-analytics' ); ?></strong>
		<?php
...
<p style="margin: 30px 0;">
	<a href="<?php echo esc_url( $file_url ); ?>"
		...
		<?php esc_html_e( 'Download CSV File', 'woocommerce-analytics' ); ?>
	</a>
</p>
