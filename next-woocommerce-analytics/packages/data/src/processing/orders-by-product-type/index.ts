 ...
 */
import { fetchReportOrdersByProductType } from '../../api/report-orders-by-product-type-fetch';
import type { Override } from '../../utils/types';
import { safeParseFloat, safeParseInt } from '../../utils/parsing';

type ReportsOrdersByProductTypeByDateResponse = Awaited<
	ReturnType< typeof fetchReportOrdersByProductType >
>;
