...
define( 'WC_ANALYTICS_VERSION', '0.9.12' ); // WRCS: DEFINED_VERSION.
...
define( 'WC_ANALYTICS_NEXT_ADMIN_ABSPATH', plugin_dir_path( __FILE__ ) . 'next-woocommerce-analytics/' );
